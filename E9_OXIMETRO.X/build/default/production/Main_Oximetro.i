...
# 15 "Main_Oximetro.c" 2


# 1 "./Configuracion.h" 1
# 17 "Main_Oximetro.c" 2

# 1 "./ADC.h" 1
# 24 "./ADC.h"
void ADC_Conversion(void);
uint16_t ADC_Read(uint8_t CHx);
# 18 "Main_Oximetro.c" 2
...
# 97 "Main_Oximetro.c"
        ...
        if(cont>=5){
            ...
            if(Saturacion > 90.0) {
                LCD_I2C_WriteText(1,0,"SAT. OPTIMA ");
            }
            if(Saturacion > 85.0 && Saturacion < 90.0) {
                LCD_I2C_WriteText(1,0,"SAT. MODERADA ");
            }
            if(Saturacion < 85.0) {
                LCD_I2C_WriteText(1,0,"SAT. SEVERA ");
            }
       }


        s1_Actual = PORTAbits.RA1;
        if(!s1_Anterior && s1_Actual){
            LATBbits.LATB3=1;
            C1=1;
        ...
        s2_Actual=PORTAbits.RA2;
        if(!s2_Anterior && s2_Actual){
